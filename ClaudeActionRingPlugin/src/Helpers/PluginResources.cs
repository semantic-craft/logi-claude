namespace Loupedeck.ClaudeActionRingPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ClaudeActionRingPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ClaudeActionRingPlugin.Resources.Resource.txt`.
