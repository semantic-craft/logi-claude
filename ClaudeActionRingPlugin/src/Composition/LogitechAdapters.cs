...
namespace Loupedeck.ClaudeActionRingPlugin.Composition
{
    ...
    internal sealed class LogitechActionImageInvalidator : IActionImageInvalidator
    {
        ...
        private readonly ClaudeActionRingPlugin _plugin;

        internal LogitechActionImageInvalidator(ClaudeActionRingPlugin plugin)
        {
        ...
        internal static IReadOnlyList<HapticEventDefinition> Definitions { get; } =
            Array.AsReadOnly(new[]
            {
                new HapticEventDefinition(
                    ...
                    "Dispatch Requested",
                    "A local delivery request was accepted; the Claude outcome is unknown."),
                new HapticEventDefinition(
