...
python3 tools/validate/validate.py \
  ...
  --output ../.scratch/claude-action-ring-implementation/evidence/scope-cleanup/run-1
```
...
python3 tools/validate/validate.py \
  --official-tool /path/to/logiplugintool \
  --official-dotnet-root /path/to/dotnet8 \
  --reuse-build-from ../.scratch/claude-action-ring-implementation/evidence/scope-cleanup/run-1/report.json \
  --output ../.scratch/claude-action-ring-implementation/evidence/scope-cleanup/run-2
```
