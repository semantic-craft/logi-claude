namespace Loupedeck.CodexActionRingPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.CodexActionRingPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.CodexActionRingPlugin.Resources.Resource.txt`.
